...
(defn tags->behaviors [ts]
  (let [duped (apply concat (map @tags (specificity-sort ts false)))
        de-duped (reduce
                   (fn [res cur]
